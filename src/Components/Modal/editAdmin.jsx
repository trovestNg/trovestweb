...
import { adminUpdateAgentBio, adminUpdateBio } from "../../Sagas/Requests";
...
const EditAdmin = ({ on, off, check, success, onSuccess, offSuccess, info, reload }) => {
    ...
    async function onSubmit (value, action) {
        ...
        try {
            ...
            const response = await adminUpdateBio(payload)
