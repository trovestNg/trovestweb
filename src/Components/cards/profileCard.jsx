...
const ProfileCard = ({ icon, mWidth, width, height, info, value, tColor, title, onClickEdit, onClickReset, page }) => {
    return (
        <Card className="d-flex flex-row shadow-sm rounded-3 p-2 border-0"
            ...
            <div className="p-2 w-75">
                <div className="d-flex gap-5 w-100 justify-content-between ">
                    <p style={{ fontFamily: 'header-font', fontSize: '1.6em' }} className="text-capitalize">{`${info?.first_name} ${info?.last_name}`}</p>
