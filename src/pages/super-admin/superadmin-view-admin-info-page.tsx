...
import AdminsPagination from "../../components/paginations/admins-paginations";
import { IAdmin, IAgent } from "./superadmin-dashboardpage";
import AdminAgentsPagination from "../../components/paginations/admin-agents-paginations";
...
const SuperAdminViewAdminInfoPage = () => {
    ...
    const [adminAgents, setAdminAgents] = useState<IAdmin[]>([]);
    ...
    return (
        <div className="w-100 p-0">
            ...
            <div className="w-100 d-flex justify-content-between">
                ...
                <p className="fw-bold">Admin Information</p>
                            ...
                            <div>
                                <div className="d-flex gap-3">
                                    ...
                                    <div>
                                        ...
                                        <p className="p-0 m-0 text-primary fw-bold">{`Total Deposits : ${convertToThousand(totalDeposits)}.`}</p>
                    ...
                    }
                    {
                        ...
                        <div className="mt-3 w-100" >
                            <div className="w-100 d-flex justify-content-between align-items-center">
                                <p className="fw-bold m-0 p-0">Agents under this admin</p>
                            ...
                            </div>
                            {
                                sloading ? <table className="table table-stripped w-100">
                                    ...
                                    <AdminAgentsPagination data={adminAgents} />
                            }
                        </div>}
...
export default SuperAdminViewAdminInfoPage;