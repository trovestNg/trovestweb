...
const DisabledArtisans = ({ data, reloadComp }) => {
                ...
                <tbody>
                    {
                       loading ? <tr className="w-100 text-center">
                             ...
                             <tr>
                                 <td colSpan={6}>
                                     <p className="font-weight-bold w-100 text-center" style={{ fontFamily: 'title-font' }}>Coming Soon</p>
                                 </td>
                             </tr> :
                                [].map((agent, index) => (
                                    <tr
...
export default DisabledArtisans;