...
import { createSuperAdminAdmin } from '../../../Sagas/Requests'
...
const CreateAdmin = ({ on, off, check, success, onSuccess, offSuccess }) => {
    ...
    async function createAdminAccount(value) {
        ...
        try {
            ...
            const response = await createSuperAdminAdmin(formdata, superAdminToken)
            ...
            {({ values, handleChange, handleSubmit, errors }) => (
                <>
                        ...
                        <ModalBody className="d-flex justify-content-center">
                            <Form className="w-75 gap-3 d-flex justify-content-center">
                                <Row className="d-flex flex-row w-100 m-0 w-100">
                                    <Col>
                                        <InputGroup className='bg-transparent border  px-2 gap-2 border-primary rounded d-flex justify-content-start align-items-center'>
                                ...
                                <Row className="d-flex gap-2 m-0 flex-row w-100 mt-3  w-100">
                                    <Col>
                                        ...
                                        <i className="bi bi-lock-fill text-primary"></i>
                                            ...
                                            <i className={secureText ? "bi bi-eye-fill text-primary" : "bi bi-eye-slash-fill text-primary"} onClick={() => setSecureText(!secureText)}></i>
                                        </InputGroup>
                                    </Col>
                                    <Col>
                                        <InputGroup className='bg-transparent border  px-2 gap-2 border-primary rounded d-flex justify-content-start align-items-center'>
                                        <i className="bi bi-lock-fill text-primary"></i>
                                            ...
                                            <i className={secureCText ? "bi bi-eye-fill text-primary" : "bi bi-eye-slash-fill text-primary"} onClick={() => setSecureCText(!secureCText)} ></i>
                                        </InputGroup>
                                    </Col>
                                </Row>
                                ...
                                <Row className="d-flex m-0 flex-row w-100 mt-3  w-100">
                                    <Col>
                                        <InputGroup className='bg-transparent border  gap-2 border-primary rounded d-flex justify-content-start align-items-center'>
                                ...
                                <Row className="d-flex m-0 flex-row mt-3 w-100">
                                    ...
                                    <Col>
                                        <InputGroup>
                                            <Button type="rest" onClick={off}>Cancel</Button>
                                        </InputGroup>
                                    </Col>
                                </Row>
                            </Form>
                    ...
                    <Modal show={success} centered>
                        <Modal.Header className='bg-primary text-light py-0' style={{ fontFamily: 'Montserrat-Bold' }}>
