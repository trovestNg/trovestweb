...
import style from './sAdminCont.module.css';
...
const SAdminContainer = (currentUser) => {
    ...
    return (
        <div className={`sadcontainer ${style.superAdcontainer}`} id="sadcontainer" style={{ fontFamily: 'primary-font' }}>
            <div className="sideBar">
                <PrimarySidebar userType={userData?.userType} userInfo={userData} />
            </div>
            <div className="w-100">
...
export default SAdminContainer;