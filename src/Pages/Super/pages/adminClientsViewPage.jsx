            ...
            <div className="d-flex gap-3 mt-4 justify-content-center">
                {
                    loading ? <Spinner /> :
                        <>
                            < InfoCard title={'Approved Artisans'} value={20} tColor={'#01065B'} icon={"bi bi-people-fill"} width={'18em'} height={'7.7em'} />
                            < InfoCard title={'Pending Artisans'} value={20} tColor={'#01065B'} icon={"bi bi-people-fill"} width={'18em'} height={'7.7em'} />
                            < InfoCard title={'Disabled Artisans'} value={20} tColor={'#01065B'} icon={"bi bi-people-fill"} width={'18em'} height={'7.7em'} />
