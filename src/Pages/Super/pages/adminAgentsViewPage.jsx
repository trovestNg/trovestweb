            ...
            <div className="d-flex gap-3 mt-4 justify-content-center">
                {
                    loading ? <Spinner /> :
                        <>
                            < InfoCard title={'Approved Agents'} value={20} tColor={'#01065B'} icon={"bi bi-people-fill"} width={'18em'} height={'7.7em'} />
                            < InfoCard title={'Pending Approval'} value={20} tColor={'#01065B'} icon={"bi bi-people-fill"} width={'18em'} height={'7.7em'} />
                            < InfoCard title={'Disabled Agents'} value={20} tColor={'#01065B'} icon={"bi bi-people-fill"} width={'18em'} height={'7.7em'} />
