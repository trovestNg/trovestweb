        ...
        <div className="w-100 py-1 px-0">
            <div className="d-flex w-100 justify-content-between px-5">
                ...
                <div className="">
                    {
                        loading ? <Spinner size="sm" /> :
                            <ArtisanProfileCard updateInfoClicked={()=>setEditArtisanModal(true)} debitArtisanClicked={()=>setDebitModal(true)} title={'Total Revenue'} value={totalCollections} info={agentData} tColor={'#01065B'} icon={"bi bi-bank2"} width={'40em'} height={'17em'} />
                    }
            ...
            <div className="w-100 mt-5">
                <div className="d-flex align-items-center w-100">
                    ...
                    <h4 className="px-2 w-75 text-info" style={{ fontFamily: 'title-font' }}>Artisan's Saving Record</h4>
