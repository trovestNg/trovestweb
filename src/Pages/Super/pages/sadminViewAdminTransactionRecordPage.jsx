...
const SuperAdminViewAdminTransactionRecordPage = () => {
    const { id } = useParams();
                ...
                <div className="">
                    {
                        loading ? <Spinner size="sm" /> :
                            <ProfileCard page={'transaction'} title={'Total Revenue'} value={totalCollections} info={agentData} tColor={'#01065B'} icon={"bi bi-bank2"} width={'40em'} height={'17em'} />
                    }
...
export default SuperAdminViewAdminTransactionRecordPage;