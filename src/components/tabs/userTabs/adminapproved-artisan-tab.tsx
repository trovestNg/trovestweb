...
import SuperAgentsPagination from "../../paginations/superagents-paginations";


const AdminApprovedArtisanTab: React.FC<any> = ({agents}) => {
    ...
    return (
        <div className="w-100">
            <div className="d-flex w-100 justify-content-between">
                ...
                {/* <div className="">
                    <Button variant="secondary" style={{ minWidth: '100px' }}>Create New Policy</Button>
                </div> */}
            </div>
...
export default AdminApprovedArtisanTab;