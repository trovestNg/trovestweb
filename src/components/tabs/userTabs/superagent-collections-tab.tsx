...
import AgentDepositPagination from "../../paginations/agent-deposit-paginations";
import AgentCollectionPagination from "../../paginations/agent-collection-paginations";
import SuperAgentCollectionPagination from "../../paginations/superagent-collection-paginations";


const SuperAgentCollectionsTab: React.FC<any> = ({thrifts}) => {
    ...
    return (
        <div className="w-100">
            <div className="d-flex w-100 justify-content-between">
                ...
                <div className="d-flex align-items-center gap-2" style={{ position: 'relative' }}>
                        ...
                        <Button
                            ...
                            variant="primaryy" style={{ minWidth: '100px', marginRight: '-5px', minHeight:'2.4em' }}>Search</Button>
                    </div>
            ...
            <div className="mt-4" >
                        ...
                        <SuperAgentCollectionPagination data={thrifts}/>
...
export default SuperAgentCollectionsTab;