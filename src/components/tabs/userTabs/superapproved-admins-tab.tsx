...
import AdminsPagination from "../../paginations/admins-paginations";
import SuperAdminsPagination from "../../paginations/superadmins-paginations";


const SuperApprovedAdminsTab: React.FC<any> = ({agents}) => {
    ...
    return (
        <div className="w-100">
            ...
            <div className="mt-4" >
                        ...
                        <SuperAdminsPagination data={agents}/>
...
export default SuperApprovedAdminsTab;