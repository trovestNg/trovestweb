...
import SuperArtisansSavingsPagination from "../../paginations/superatisans-savings-paginations";


const SuperArtisanSavingTab: React.FC<any> = ({thrifts}) => {
    ...
    return (
        <div className="w-100">
            ...
            <div className="mt-4" >
                        ...
                        <SuperArtisansSavingsPagination data={thrifts}/>
...
export default SuperArtisanSavingTab;