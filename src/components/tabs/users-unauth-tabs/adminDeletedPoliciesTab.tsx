...
import AdminDelPolicyPagination from "../../paginations/admin/admin-del-policy-pagiantion";
            ...
            <div className="mt-4" >
                {
                    loading ? <table className="table table-stripped w-100">
                        ...
                        <AdminDelPolicyPagination data={policies} refData={()=>setRefreshData(!refreshData)}/>
                }
            </div>
            {/* {
                policies.length <= 0 ? '' :v
