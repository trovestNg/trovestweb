...
const SureToDeclineDeleteSingleBmoModal: React.FC<any> = ({ show, Id, off, clickedOwner }) => {
    ...
    const deleteBo = async (body: any) => {
        ...
        if (userInfo) {
            ...
            const res = await api.post(`delete/undo`, delBody, `${userInfo?.access_token}`)
            if (res?.status == 200) {
                setLoading(false);
            ...
            <Modal show={show} centered>
                ...
                <Modal.Body>
                    <div className="py-2 d-flex justify-content-center align-items-center flex-column">
                        ...
                        <p className="text-center px-3">You are about to decline this deletion request.</p>
...
export default SureToDeclineDeleteSingleBmoModal