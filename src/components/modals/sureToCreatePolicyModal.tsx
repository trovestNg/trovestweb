...
const SureToCreatePolicyModal : React.FC<any> = ({show, off, action, loading})=>{
        ...
        <Modal show={show} centered>
                ...
                <Modal.Body>
                    <div className="py-2 d-flex justify-content-center align-items-center flex-column">
                        ...
                        <p className="text-center px-3">You are about to upload a policy. Please ensure you have reviewed it thoroughly before sending to the authorizer.</p>
...
export default SureToCreatePolicyModal