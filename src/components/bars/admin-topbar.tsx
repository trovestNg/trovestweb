...
const AdminTopbar: React.FC<any> = ({ payload }) => {
    ...
    return (
        <div
            ...
            <p className="p-0 m-0 text-secondary">Admin Portal</p>
{/* <p>{timer}</p> */}
            <div className="px-1">
                ...
                <img className="shadow shadow-sm p-1"  src={user?.image} height={'40px'} width={'40px'}  style={{borderRadius:'40px'}}/>
                    ...
                    <p className="p-0 m-0 text-secondary">{`${user?.first_name} ${user?.last_name}`}</p>
