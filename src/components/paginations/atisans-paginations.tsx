...
const ArtisansPagination: React.FC<any> = ({ data }) => {
            ...
            <table className="table table-striped border border-1 w-100">
                <thead className="thead-dark">
                    <tr >
                        ...
                        <th scope="col" className="bg-secondary text-light">Name</th>
                        <th scope="col" className="bg-secondary text-light">Phone Number</th>
                        <th scope="col" className="bg-secondary text-light">Balance</th>
                        <th scope="col" className="bg-secondary text-light">Date started</th>
                    </tr>
                </thead>
                <tbody>
...
export default ArtisansPagination;