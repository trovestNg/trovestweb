...
const UnauthFirstLayerPagiantion: React.FC<any> = ({ data, refData }) => {
    ...
    return (
        <div>
            ...
            />
            <div className=" p-1" style={{ overflowY: 'scroll', height: '65vh' }}>
            ...
            <thead className="thead-dark">
                ...
                <tbody>
                    {data.length <= 0 ? <tr><td className="text-center" colSpan={7}>No Data Available</td></tr> :
                        currentItems.map((bmo: IOwner, index: any) => (
                            ...
                            >
                                ...
                                <td className="text-primary">{bmo.BusinessName}</td>
                                <td>{bmo.CountryName}</td>
                                <td>{bmo.Category}</td>
                                <td>{bmo.IdType}</td>
                                <td>{bmo.Ticker}</td>
                                <td>{bmo.RcNumber}</td>
...
export default UnauthFirstLayerPagiantion;