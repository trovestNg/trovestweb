...
const AgentsPagination: React.FC<any> = ({ data }) => {
            ...
            <table className="table table-striped border border-1 w-100">
                <thead className="thead-dark">
                    <tr >
                        ...
                        <th scope="col" className="bg-secondary text-light">Email</th>
                        <th scope="col" className="bg-secondary text-light">No of Customers</th>
                    </tr>
                </thead>
                <tbody>
