...
import { Card, ListGroup, ListGroupItem, Pagination, Tooltip, OverlayTrigger } from "react-bootstrap";
...
const AdminAllPolicyPagination: React.FC<any> = ({ data, refData }) => {
...
export default AdminAllPolicyPagination;